...
{
	public class RedJunglefowlProjectile : ModProjectile
	{
		...
		public override void SetDefaults() {
			...
			Projectile.aiStyle = 4; // The ai style of the projectile, please reference the source code of Terraria
			...
			AIType = ProjectileID.NettleBurstRight;
