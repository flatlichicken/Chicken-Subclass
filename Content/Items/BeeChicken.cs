...
namespace Chickensubclass.Content.Items
{
	...
	public class BeeChicken : ModItem
	{
...
public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
{
    ...
    return false;
		...
		{
			Recipe BeeChickenRecipe = CreateRecipe();
			BeeChickenRecipe.AddIngredient(ItemID.BeeKeeper, 1);
			BeeChickenRecipe.AddIngredient(ModContent.ItemType<Content.Items.ChickenFeather>(), 15);
			BeeChickenRecipe.AddIngredient(ModContent.ItemType<Content.Items.RawChicken>(), 10);
			BeeChickenRecipe.AddTile(TileID.Anvils);
			BeeChickenRecipe.Register();
