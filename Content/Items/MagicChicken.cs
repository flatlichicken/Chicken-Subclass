...
namespace Chickensubclass.Content.Items
{
	...
	public class MagicChicken : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.useTurn = false;
			Item.shoot = ModContent.ProjectileType<MagicChickenProjectile>();
		...
		{
			Recipe MagicChickenRecipe = CreateRecipe();
			MagicChickenRecipe.AddIngredient(ModContent.ItemType<Content.Items.Chicken>());
			MagicChickenRecipe.AddIngredient(ItemID.EnchantedSword, 1);
			MagicChickenRecipe.AddTile(TileID.Anvils);
			MagicChickenRecipe.Register();
