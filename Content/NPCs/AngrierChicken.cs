...
namespace Chickensubclass.Content.NPCs
{
	...
	public class AngrierChicken : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			NPC.Banner = NPC.type;
            NPC.BannerItem = ModContent.ItemType<Items.AngrierChickenBanner>();
		}
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot) {
			...
			npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<ChickenSoul>(), 1, 1, 1));
		...
		public override void AI() {
        	...
        	SoundEngine.PlaySound(new SoundStyle("Chickensubclass/Content/NPCs/AngierChickenNoise"), NPC.position);
    		}
