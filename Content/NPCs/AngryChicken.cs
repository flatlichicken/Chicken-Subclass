...
namespace Chickensubclass.Content.NPCs
{
	...
	public class AngryChicken : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			return SpawnCondition.OverworldDaySlime.Chance * 0.35f; // Spawn with 1/5th the chance of a regular zombie.
		}

		public override void AI() {

			if (Main.rand.NextBool(600)) { 
        	SoundEngine.PlaySound(new SoundStyle("Chickensubclass/Content/NPCs/ChickenNoise"), NPC.position);
    		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange([
				...
				new FlavorTextBestiaryInfoElement("Mods.Chickensubclass.Bestiary.AngryChicken"),
