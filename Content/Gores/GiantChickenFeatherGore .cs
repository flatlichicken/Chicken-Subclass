...
namespace Chickensubclass.Content.Gores
{
    ...
    public class GiantChickenFeatherGore : ModGore
    {
        ...
        public override bool Update(Gore gore) {
            // 4. Makes feathers fall slower than normal heavy gore
            gore.velocity.Y *= 0.95f; 
            
            // 5. Let vanilla handle rendering, movement, and fading out
            return true; 
        }
    }
}